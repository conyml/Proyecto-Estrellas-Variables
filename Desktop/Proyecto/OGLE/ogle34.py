...
id_star=pd.read_csv("ident.dat",header=None, delimiter=r"\s+", 
...
pathV_O4 = '/Users/Carolina/Desktop/Proyecto/OGLE/phot_O4/V'
pathI_O4 = '/Users/Carolina/Desktop/Proyecto/OGLE/phot_O4/I'

pathV_O3 = '/Users/Carolina/Desktop/Proyecto/OGLE/phot_O3/V'
pathI_O3 = '/Users/Carolina/Desktop/Proyecto/OGLE/phot_O3/I'

filesV_O4 = glob.glob(os.path.join(pathV_O4, '*.dat'))
filenamesV_O4= [x[48:-4] for x in filesV_O4]
filesI_O4 = glob.glob(os.path.join(pathI_O4, '*.dat'))
filenamesI_O4= [x[48:-4] for x in filesI_O4]

filesV_O3 = glob.glob(os.path.join(pathV_O3, '*.dat'))
filenamesV_O3= [x[48:-4] for x in filesV_O3]
filesI_O3 = glob.glob(os.path.join(pathI_O3, '*.dat'))
filenamesI_O3= [x[48:-4] for x in filesI_O3]
...
for i in range(len(identI)):
	...
	if identV['Stars ID'][i] not in filenamesI_O3:
		y=np.loadtxt(algo2+'.dat').T
...
for i in identV.index:
	...
	dfV.to_csv('/Users/Carolina/Desktop/Proyecto/OGLE/Lightcurves OGLE/V/'+identV['Stars ID'][i]+'.dat', sep=',', index=False)		
...
for i in identI.index:	
	...
	dfI.to_csv('/Users/Carolina/Desktop/Proyecto/OGLE/Lightcurves OGLE/I/'+identI['Stars ID'][i]+'.dat', sep=',', index=False)	
	
#cepF=pd.read_csv("cepF.dat", header=None, delimiter=r"\s+", 
...
#cepF_03=pd.read_csv("cepF.dat", header=None, delimiter=r"\s+", 
	#names=['Stars ID', 'Intensity mean I-band magnitude', 
	#'Intensity mean V-band magnitude','Period', 'Uncertainty of period',
	#'Time of maximum brightness (HJD-2450000)',
	#'I-band amplitude (maximum-minimum)','Fourier coefficient R_21',
